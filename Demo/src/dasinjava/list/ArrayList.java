...
public class ArrayList<E> implements List<E>{
    ...
    /**
     * A (nonstatic) inner. Note well that each instance contains an implicit
    ...
    private class ArrayIterator implements Iterator<E> {
        ...
        public void remove() throws IllegalStateException{
            ...
            j--;                                    // next element has shifted one cell to the lift                            
            removable = false;                      // do not allow remove agian until next is called
        }
    } //-------------- end of nested ArrayIterator class -----------

    /** Returns an iterator of the elements stored in the list. */
    public class ArrayIterable implements Iterable<E>{
        public Iterator<E> iterator() {
            return new ArrayIterator();                 // create a new instance of the inner class
        }
    }
    
    public Iterable<E> ArraySet() {
    ...
    /** Inserts element e to be at the end of arraylist whose index i=size */
