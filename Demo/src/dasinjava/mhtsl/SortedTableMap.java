...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
	...
	/** Returns the smallest index for range table[low...high] inclusive storing an entry with a key greater than or equal to k (or else index high+1, by convention). */
	...
	/** Returns the given value with the given key, retur ning any overridden value. */
